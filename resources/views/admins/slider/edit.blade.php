...
@section('content')
  <!--== User Details ==-->
         ...
         @include('includes.Errors')
             {!! Form::model($slide, ['method'=>'PATCH','action'=> ['slidercontroller@update' , $slide->id],'files'=>true]) !!}
            ...
            <div class="row" >
               ...
               <div class="input-field col s12">
                ...
                <div class="input-field col s12">
                         {!! Form::label('name', 'Enter Tag 3  (max characters 15)') !!}
                        {!! Form::text('tags3', null, ['class'=>'validate']) !!}
               </div>
               <div class="input-field col s12">
                         {!! Form::label('details', 'Enter Details (max characters 150)') !!}
                        {!! Form::textarea('details', null, ['class'=>'validate']) !!}
               </div>
                ...
                {!! Form::file('photo_id', ['class'=>'required', 'multiple']) !!}
                  ...
                  <div class="file-path-wrapper">
                     ...
                     <br >  <br >  <br >
                   {!! Form::open(['method'=>'DELETE','action'=> ['slidercontroller@destroy',$slide->id]]) !!}  
