...
@if($lab)
            ...
            {{-- loop start --}}
               ...
               <div class="single-event">
                      <div class="head overlay">
                        ...
                        <a href="{{ url('images/'.$labs->photo->photo_tag) }}" data-fancybox="photo" class="btn"><i class="fa fa-search-plus"></i></a>
                          </div>
 ...
 @endif
    ...
    {{--   <img src="{{ $$dent->photo_id?$dent->photo->photo_tag:'http://placehold.it/400X400' }}" alt="">  --}}                                            </div>
                                  ...
                                  <div class="event-slider">
                                      ...
                                      <div class="single-event">
                                          <div class="head overlay">
                                              ...
                                              <a href="{{ URL::asset('images/'.$events->photo->photo_tag) }}" data-fancybox="photo" class="btn"><i class="fa fa-search-plus" ></i></a>
                                          </div>
                                          <div class="event-content">
                                              <div class="meta"> 
                          ...
                          <div class="single-blog">
                              ...
                              <div class="blog-content">
                                  ...
                                  <div class="blog-info">
                                      ...
                                      <a href="#"><i class="fa fa-calendar"></i>{{ $new->created_at->diffForHumans() }}</a>
                                  </div>
